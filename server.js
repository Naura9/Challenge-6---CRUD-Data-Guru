...
//endpoint memanggil semua data guru
...
//endpoint mengambil 1 data guru berdasarkan :id
...
//endpoint menyimpan data guru baru
app.post("/guru", (req, res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            response = {
                message: result.affectedRows + " data berhasil tersimpan"
            }            
        }
        res.json(response) // send response
    })
...
//endpoint mengubah data guru berdasarkan id
...
//endpoint menghapus data guru berdasarkan id
